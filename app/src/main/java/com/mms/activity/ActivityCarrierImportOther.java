 ...
 */
@ContentView(R.layout.layout_activity_carrier_import_other)
public class ActivityCarrierImportOther extends BaseActivity implements View.OnClickListener {

    @InjectView(R.id.btn_activity_carrier_import_other_back)
    private Button btnBack;

    @InjectView(R.id.et_activity_carrier_import_other_title)
    private CancelableEditView etTitle;

    @InjectView(R.id.et_activity_carrier_import_other_address)
    private CancelableEditView etAddress;

    @InjectView(R.id.rl_activity_carrier_import_other_level)
    ...
    @InjectView(R.id.tv_activity_carrier_import_other_status)
    private TextView tvStatus;

    @InjectView(R.id.ll_activity_carrier_import_other_contacts)
    private LinearLayout llContacts;

    @InjectView(R.id.ll_activity_carrier_import_other_add_and_del)
    private LinearLayout llAddAndDel;

    @InjectView(R.id.btn_activity_carrier_import_other_add_contact)
    private Button btnAddContact;

    @InjectView(R.id.oil_activity_carrier_import_other)
    private OperateImagesLayout imagesLayout;

    @InjectView(R.id.et_activity_carrier_import_other_intro)
...
//                switch (i) {
//                    case 0:
//                        Utils.showToast(ActivityCarrierImportother.this, "1");
//                        break;
//                    case 1:
//                        Utils.showToast(ActivityCarrierImportother.this, "2");
//                        break;
//                    case 2:
//                        Utils.showToast(ActivityCarrierImportother.this, "3");
//                        break;
//                    case 3:
//                        Utils.showToast(ActivityCarrierImportother.this, "4");
//                        break;
//                    case 4:
//                        Utils.showToast(ActivityCarrierImportother.this, "5");
//                        break;
//
//                }
                level = i + 1;
...
//                switch (i) {
//                    case 0:
//                        Utils.showToast(ActivityCarrierImportother.this, "待租");
//                        break;
//                    case 1:
//                        Utils.showToast(ActivityCarrierImportother.this, "待售");
//                        break;
//                    case 2:
//                        Utils.showToast(ActivityCarrierImportother.this, "已租");
//                        break;
//                    case 3:
//                        Utils.showToast(ActivityCarrierImportother.this, "已售");
//                        break;
//
//                }
                status = i + 1;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_activity_import_del_contact:
                ...
                delContact(view);
                break;
            case R.id.btn_activity_carrier_import_other_save:
                //点击保存按钮
                if (isLegal()) {
