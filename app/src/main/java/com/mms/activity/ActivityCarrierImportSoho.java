 ...
 */
@ContentView(R.layout.layout_activity_carrier_import_soho)
public class ActivityCarrierImportSoho extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {

    @InjectView(R.id.btn_activity_carrier_import_soho_back)
    private Button btnBack;

    @InjectView(R.id.et_activity_carrier_import_soho_title)
    private CancelableEditView etTitle;

    @InjectView(R.id.et_activity_carrier_import_soho_address)
    private CancelableEditView etAddress;

    @InjectView(R.id.rl_activity_carrier_import_soho_level)
    ...
    @InjectView(R.id.tv_activity_carrier_import_soho_status)
    private TextView tvStatus;

    @InjectView(R.id.ll_activity_carrier_import_soho_contacts)
    private LinearLayout llContacts;

    @InjectView(R.id.ll_activity_carrier_import_soho_add_and_del)
    private LinearLayout llAddAndDel;

    @InjectView(R.id.btn_activity_carrier_import_soho_add_contact)
    private Button btnAddContact;

    @InjectView(R.id.cb_activity_carrier_import_soho_rent)
    private CheckBox cbRent;

    @InjectView(R.id.cb_activity_carrier_import_soho_sell)
    private CheckBox cbSell;

    @InjectView(R.id.cb_activity_carrier_import_soho_cooperation)
    private CheckBox cbCooperation;

    @InjectView(R.id.et_activity_carrier_import_soho_unitnum)
    private CancelableEditView etUnitNum;

    @InjectView(R.id.et_activity_carrier_import_soho_onfloor)
    private CancelableEditView etOnFloor;

    @InjectView(R.id.et_activity_carrier_import_soho_area)
    private CancelableEditView etArea;

    @InjectView(R.id.et_activity_carrier_import_soho_pfee)
    private CancelableEditView etPFee;

    @InjectView(R.id.et_activity_carrier_import_soho_norent_price)
    private CancelableEditView etNoRentPrice;

    @InjectView(R.id.rg_activity_carrier_import_soho_deco)
    private RadioGroup rgDeco;

    @InjectView(R.id.et_activity_carrier_import_soho_rprice)
    ...
    @InjectView(R.id.btn_activity_carrier_import_soho_save)
...
//                switch (i) {
//                    case 0:
//                        Utils.showToast(ActivityCarrierImportSoho.this, "1");
//                        break;
//                    case 1:
//                        Utils.showToast(ActivityCarrierImportSoho.this, "2");
//                        break;
//                    case 2:
//                        Utils.showToast(ActivityCarrierImportSoho.this, "3");
//                        break;
//                    case 3:
//                        Utils.showToast(ActivityCarrierImportSoho.this, "4");
//                        break;
//                    case 4:
//                        Utils.showToast(ActivityCarrierImportSoho.this, "5");
//                        break;
//
//                }
                level = i + 1;
...
//                switch (i) {
//                    case 0:
//                        Utils.showToast(ActivityCarrierImportSoho.this, "待租");
//                        break;
//                    case 1:
//                        Utils.showToast(ActivityCarrierImportSoho.this, "待售");
//                        break;
//                    case 2:
//                        Utils.showToast(ActivityCarrierImportSoho.this, "已租");
//                        break;
//                    case 3:
//                        Utils.showToast(ActivityCarrierImportSoho.this, "已售");
//                        break;
//
//                }
                status = i + 1;
    ...
    private void setOCL() {
        ...
        rgDeco.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        switch (compoundButton.getId()) {
            case R.id.cb_activity_carrier_import_soho_rent:
                if (b) {
                ...
                break;
            case R.id.cb_activity_carrier_import_soho_sell:
                if (b) {
                ...
                break;
            case R.id.cb_activity_carrier_import_soho_cooperation:
                if (b) {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_activity_carrier_import_soho_back:
            ...
            case R.id.btn_activity_import_del_contact:
                ...
                delContact(view);
                break;
            case R.id.btn_activity_carrier_import_soho_save:
                //点击保存按钮
                if (isLegal()) {
    ...
    private void save() {
        showLoadingDialog();
        Utils.showToast(this, getNeed() + "     " + level + "     " + status);
        cancelLoadingDialog();
    }
    ...
    private int getUnitNum() {
        return Utils.getStringToInt(etUnitNum.getText());
    }

    private int getOnFloor() {
        return Utils.getStringToInt(etOnFloor.getText());
    }
    ...
    private double getPFee() {
        return Utils.getStringToDouble(etPFee.getText());
    }

    private int getNoRentPrice() {
        return Utils.getStringToInt(etNoRentPrice.getText());
    }
