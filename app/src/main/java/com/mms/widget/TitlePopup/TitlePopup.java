package com.mms.widget.TitlePopup;
...
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup(Context context, int width, int height){
		...
		//获得屏幕的宽度和高度
		mScreenWidth = UIUtils.getScreenWidthPX(mContext);
		mScreenHeight = UIUtils.getScreenHeightPX(mContext);
	...
	public void show(View view){
		...
		//显示弹窗的位置
		showAtLocation(view, popupGravity, mScreenWidth  - (getWidth()/2), mRect.bottom+35);
	}
